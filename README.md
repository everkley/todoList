Aplicação de gerenciamento de tarefas com suporte a CRUD, priorização e filtros. Permite criar, listar, atualizar e deletar tarefas, além de marcar tarefas como concluídas.
